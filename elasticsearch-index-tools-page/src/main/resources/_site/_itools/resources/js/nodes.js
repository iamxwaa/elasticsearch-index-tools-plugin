layui.use(['table', 'vhttp', 'vmodule', 'vtools', 'vtpl'], function () {
    ...
    var rowRoles = "<strong>{{ d.roles }}</strong>";
    var rowCpu = "<span class='node-table-info'>{{ d.os.cpu.percent }}</span>";
    var rowMemory = "<div>"
    ...
    var loadTable = function () {
        vhttp.ajax("/_nodes/stats/os,fs,jvm,indices", "GET", function (data) {
            var dataBody = [];
            var runningHosts = {};
