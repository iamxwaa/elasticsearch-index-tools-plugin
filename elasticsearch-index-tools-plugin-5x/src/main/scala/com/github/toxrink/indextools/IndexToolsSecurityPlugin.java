...
public class IndexToolsSecurityPlugin extends IndexToolsPlugin implements NetworkPlugin {
    ...
    private static SecurityAction userAction;

    private static AtomicBoolean loadingPermission = new AtomicBoolean(true);
    ...
    public List<Class<? extends ActionFilter>> getActionFilters() {
        if (indexToolsSettings.securityConfig().basicEnable()) {
            List<Class<? extends ActionFilter>> list = new ArrayList<>(1);
            list.add(VActionFilter.class);
            return list;
        }
    ...
    public Collection<Object> createComponents(Client client, ClusterService clusterService, ThreadPool threadPool, ResourceWatcherService resourceWatcherService, ScriptService scriptService, NamedXContentRegistry xContentRegistry) {
        Collection<Object> collections = super.createComponents(client, clusterService, threadPool, resourceWatcherService, scriptService, xContentRegistry);
    ...
    public static class VActionFilter implements ActionFilter {
